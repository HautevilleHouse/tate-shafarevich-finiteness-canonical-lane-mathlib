# Tate Shafarevich Finiteness — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/tate-shafarevich-finiteness-canonical-lane-mathlib.git
cd tate-shafarevich-finiteness-canonical-lane-mathlib
lake exe
lake build
```
